...
#         params = list(tuple(p.items())) + children
...
#             params += [(name + '.' + s, _ in module.named_parameters) for zip(name, module) in child]
#             params += [(name + '.' + s for s, _ in module.named_parameters) for name, module in child]
            # if child._modules:
